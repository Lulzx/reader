<div
  ...
  <div
    ...
    <div class="min-w-0 flex-auto space-y-0.5">
      <p
        class="text-cyan-600 dark:text-cyan-400 text-sm sm:text-base lg:text-sm xl:text-base font-semibold uppercase">
        Track 128
      </p>
      <h2
  ...
  <div class="space-y-2">
    <div class="bg-gray-200 dark:bg-black rounded-full overflow-hidden">
      <div
        class="bg-cyan-500 dark:bg-cyan-400 w-1/2 h-1.5"
        role="progressbar"
        aria-valuenow="1456"
        aria-valuemin="0"
        aria-valuemax="4550" />
